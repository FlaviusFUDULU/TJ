...
public class OperatiiBD {
	...
	public void insertCurs(int id_angajat, String denumire, int numar_ore, String diploma_de_absolvire, int anul, float valoare) {
	...
	public void actualizareCurs(int id_and, String denumire2, int numar_ore2, float valoare2, 
		...
		jdbcTemplateObject.update( SQL, id_and, denumire2, valoare2, numar_ore2, diploma_de_absolvire2, anul2,denumireDeActualizat);
	}
