...
public class StergereCurs extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StergereCurs frame = new StergereCurs();
	...
	public StergereCurs() {
		...
		btnSterge.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				db.stergereCurs(textFieldDenumireCurs.getText());
			}
		});
		btnSterge.setBounds(24, 301, 220, 25);
